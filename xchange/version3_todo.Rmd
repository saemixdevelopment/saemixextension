...
- **TODO** testthat functions
  ...
  - computations ?
  - display options
    - displayProgress=FALSE by default ? **DONE**
    - verbose=FALSE ? **DONE**
...
- examples
  ...
  - **DONE** categorical data, TTE data
    - **DONE*** add a section example of use with donttest to the online page
  - **DONE** RTTE data, count data (maybe count data=salamander data $\Rightarrow$ RAPI data)
- documentation
  - error models
  - **DONE** new models from Belhal for responses defined by their likelihood
  - new references
...
- **TODO** next version
  ...
  - bookdown: https://github.com/saemixdevelopment/saemix_bookdown
    ...
    - move online or keep pdf/tex version ?
      ...
      - **DONE** copy on iame github
- **DONE** dependencies
  - ggplot2 in Depends for 3.0
  - npde 3.2: 
    - Suggests for ggplot2
    - @importFrom statements in roxygen documentation for all objects from ggplot2 that are needed (ex: geom_bar,...)
