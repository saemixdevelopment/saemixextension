...
- Vraies données **TODO** ??? (difficile à trouver :-/)
  - contacté David Atkins (tutorial in 2013 on analysing count data with GLMM and GEE): dataset on gender differences in drinking patterns that would be great to use as an example in saemix
