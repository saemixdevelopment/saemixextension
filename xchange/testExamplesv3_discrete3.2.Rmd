---
title: "Testing examples in saemix 3.2 - discrete models"
author: "Emmanuelle"
date: "10/11/2022"
output:
...
saemix.model<-saemixModel(model=binary.model,description="Binary model",
           ...
           psi0=matrix(c(0,-.5,0,0.5),ncol=2,byrow=TRUE,
...
# VPC with function from library
...
discreteVPC(yfit2, outcome="count", which.cov="gender", breaks=c(0:9, 16, 25,80))
