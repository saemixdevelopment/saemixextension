...
write.csv(datsim.nocov, file=file.path(datDir,"theoSimul_nocov.csv"), quote=F, row.names = FALSE)

write.csv(datsim.cov, file=file.path(datDir,"theoSimul_cov.csv"), quote=F, row.names = FALSE)
