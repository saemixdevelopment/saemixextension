...
cond.count <- saemix.bootstrap(poisson.fit.cov2, method="conditional", nboot=nboot) 
write.table(cond.count,file.path(workDir, "bootstrapCond_rapiCov_Poisson.res"), row.names = FALSE, quote=F)
...
write.table(cond.count,file.path(workDir, "bootstrapCond_rapiCov_ZIP_corr.res"), row.names = FALSE, quote=F)
...
cond.count <- saemix.bootstrap(hurdlefit0.corr, method="conditional", nboot=nboot) 
write.table(cond.count,file.path(workDir, "bootstrapCond_rapiCov_Hurdle0_corr.res"), row.names = FALSE, quote=F)

cond.count <- saemix.bootstrap(hurdlefit1.corr, method="conditional", nboot=nboot) 
write.table(cond.count,file.path(workDir, "bootstrapCond_rapiCov_Hurdle1_corr.res"), row.names = FALSE, quote=F)
