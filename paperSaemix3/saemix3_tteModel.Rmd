...
- exponential model: $ h(t) = \frac{1}{T_e} $
- Gompertz: $h(t) = \frac{\gamma}{T_e'} \; e^{\frac{t}{T_e'}}$ & $\gamma \; (e^{\frac{t}{T_e'}}-1)$ where $T_e'=\frac{T_e}{ln \left( 1+ \frac{ln(2)}{\gamma} \right)}$
- gamma model: $h(t)= \frac{1}{T_e \Gamma(k)} \left( \frac{t}{T_e} \right)^{(k-1)} \, e^{-\frac{t}{T_e}}$
- log-logistic model: $h(t) = TODO $
