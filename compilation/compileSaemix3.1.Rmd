---
title: "Package compilation for saemix 3.1 and basic run"
...
workDir<-"/home/eco/work/saemix/versions/saemix3.1"
knitr::opts_chunk$set(root.dir = workDir)

# Options
testExamples <- TRUE
checkReverseDependencies <- FALSE
...
# Test examples
if(testExamples) 
  system("R CMD check --as-cran --run-donttest saemix_3.1.tar.gz") else 
    system("R CMD check --as-cran saemix_3.1.tar.gz")
...
if(installPackage) {  
  ...
  install.packages(pkgs=file.path(workDir,"saemix_3.1.tar.gz"),repos=NULL)
