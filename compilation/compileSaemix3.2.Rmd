---
title: "Package compilation for saemix 3.2 and basic run"
...
workDir<-"/home/eco/work/saemix/versions/saemix3.2"
...
# Test examples
if(testExamples) 
  system("R CMD check --as-cran --run-donttest saemix_3.2.tar.gz") else 
    system("R CMD check --as-cran saemix_3.2.tar.gz")
...
if(installPackage) {  
  ...
  install.packages(pkgs=file.path(workDir,"saemix_3.2.tar.gz"),repos=NULL)
