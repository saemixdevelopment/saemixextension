context("Testing auxiliary functions - old version with combined 1 error model  (g=(a + b f)^2), deprecated in 3.0\n")
...
test_that("Sum of squares", {
  ...
  xt1<-((y1-f1)**2)/((ab3[1]+ab3[2]*f1)**2) + 2*log((ab3[1]+ab3[2]*f1))
