...
# control = list(options)
  ...
  if(saemixObject["options"]$save.graphs == T) cat("WARNING: Graphs are not currently extended for joint models. Error will occur at the end of the algorithm and results won't be saved")
  ...
  print(saemix.options$nbiter.tot)
  ...
  # j'ai mit de côté aussi car y'a une erreur - Lucas 
...
#     x<-saemixObject
  ...
  # importance sampling  j'ai eu un crash
