...
{\color[named]{Brown} { \Large \itshape Belhal Karimi~$^{4}$, Maud Delattre~$^5$, Johannes Ranke~$^6$}
}

{\color[named]{Brown} { \Large \itshape Lucie Fayette~$^{1,2}$, Marilou Chanel~$^{1,2}$, Sofia Kaisaridi$^{1,2}$}
}
\vskip 3cm
\end{center}
...
{\color[named]{Brown}{$^4$ INRIA, Saclay, France}}

{\color[named]{Brown}{$^5$ France}}

{\color[named]{Brown}{$^5$ Germany}}
