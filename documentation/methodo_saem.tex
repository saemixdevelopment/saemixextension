...
\section{Estimation of the uncertainty} \label{sec:SE} 

\subsection{Estimation of the Fisher Information matrix} \label{sec_fish} 
...
Bootstrap approaches for NLMEM

~\cite{Thai13}

Conditional bootstrap (see conditional distributions in section~\ref{section_indivparam}
~\cite{Comets21bootstrap}
