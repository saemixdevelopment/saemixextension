...
#' @param method the name of the bootstrap algorithm to use (one of: "case", "residual", "parametric" or "conditional")
...
#' 
#' @details Different bootstrap algorithms have been proposed (Thai 2013, 2014) for
#' non-linear mixed effect models, to account for the hierarchical nature of these models.
