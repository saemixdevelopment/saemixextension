...
The full set of simulated data and bootstrap distributions used for the paper have been uploaded to the Zenodo archive system <https://zenodo.org/>

**TODO: upload and add link**

```{r setup, include=FALSE}
knitr::opts_chunk$set(echo = TRUE)
## If required, set your working directory, otherwise will run in the current directory
## workDir<-"/my/path/to/saemixextension"
workDir<-"."
...
### Bootstrap distributions for the simulated data in scenario SHill,R
...
cairo_pdf(file.path(workDir,"bootstrap","fig1_paper.pdf"),width = 8, height=11)
print(plot.density)
dev.off()

```

## Running bootstrap methods on one dataset
...
cairo_pdf(file.path(workDir,"bootstrap","fig1_interactive.pdf"),width = 8, height=11)
print(plot.density2)
dev.off()
